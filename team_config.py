...
class FgoTeamConfiguration:
    def __init__(self, team_servant_id: List[int], team_craft_essence_id: List[int],
                 support_servant_id: int, support_craft_essence_id: int, support_position: int,
                 support_craft_essence_max_break: bool = False, support_skill_requirement: Optional[List[int]] = None,
                 friend_only: bool = False, priority: int = 1):
        ...
        self.support_craft_essence_max_break = support_craft_essence_max_break
        self.support_skill_requirement = support_skill_requirement or [0, 0, 0]
