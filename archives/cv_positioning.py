...
# 助战技能框位置，已更新至被动技能layout（调整前->调整后）
CV_SUPPORT_SKILL_BOX_SIZE = 35  # 宽高=55->35px
CV_SUPPORT_SKILL_BOX_MARGIN_X = 10  # 两个技能框间的margin像素 23->10
CV_SUPPORT_SKILL_BOX_OFFSET_Y = 135  # 技能框从检测到的助战Y1开始往下偏移的像素 115->135
...
CV_SUPPORT_SKILL_BINARIZATION_THRESHOLD = 85 / 255  # original 85 / 255, found it's higher
