# from ._class_def import APRecoveryItemType, TeamConfig, BattleController
# from typing import *
# import logging
#
...
# class ScriptConfig:
#     def __init__(self, eat_apple_type: APRecoveryItemType, battle_controller: Type[BattleController],
